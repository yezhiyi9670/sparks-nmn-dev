...
====
S: DoReMi
N: 1. (2) 3. (1) | 3 1 3 0 | 2. (3) (44) (32) | 4 - - - |
Lw: Do, a deer, a fe-male deer, Re, a drop of gol-den sun.
// ---
// N: 3. (4) 5. (3) | 5 3 5 0 | 4. (5) (66) (54) | 6 - - - | 5 - - - |
// Lw: Mi, a name, I call my-self, Fa, a long long way to run-a_{0}
// ====
// S: 片段A
// Sp: 6/8 1=#E spm=225
// ---
// N: 3. 3 (1) |{}{"嘿嘿, 寄咯"} #2. 7d. | 2. (217d) | 7d. (7d12) | 3. 3(1) | #2. #4(7) | 6. (6#56) |
// F: < - - | fp | "你妈的为什么这么远"
// C: "#C7(sus4)/E" | "G"
// A: 
// A: "test" | "text"
// Lc["h1", 1.]: 翻开下一页, 请稍候床边, 打碎了橘子酱发现橱窗里的世
...
// Lc["h1", 1., 3.]: 界. 跟随着萤火虫的曲线, 那兔子的礼服里掉落请柬, 鸢尾装点, 灌木林背面, 排列了盛宴_{0}
